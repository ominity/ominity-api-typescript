...
export interface Env {
  OMINITY_API_KEY?: string | undefined;
  OMINITY_OAUTH_TOKEN?: string | undefined;

  OMINITY_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, unknown> = z.object({
  OMINITY_API_KEY: z.optional(z.string()),
  OMINITY_OAUTH_TOKEN: z.optional(z.string()),

  OMINITY_DEBUG: z.optional(z.coerce.boolean()),
});
