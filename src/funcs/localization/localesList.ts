...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.LocalizationLocalesListParams$outboundSchema.optional()
        .parse(value),
  ...
  const context = {
    ...
    operationID: "localization.locales.list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, LocalesListResponse$inboundSchema, {
