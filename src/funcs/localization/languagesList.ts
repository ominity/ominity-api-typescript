...
import { LanguagesListResponse$inboundSchema } from "../../models/localization/language.js";
import { applyPaginationParams } from "../../models/pagination.js";
import { APICall, APIPromise } from "../../types/async.js";
import { OK, Result } from "../../types/fp.js";

export function localizationLanguagesList(
  client: ClientSDK,
  request?: operations.ListLocalizationLanguagesRequest | undefined,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListLocalizationLanguagesResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.LocalizationLanguagesListParams$outboundSchema.optional()
        .parse(value),
  ...
  const path = "/localization/languages";
  ...
  const context = {
    ...
    operationID: "localization.languages.list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, LanguagesListResponse$inboundSchema, {
