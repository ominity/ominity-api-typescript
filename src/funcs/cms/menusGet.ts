...
> {
    const parsed = safeParse(
        request,
        (value) => operations.GetMenuRequest$outboundSchema.parse(value),
    ...
    const [result] = await M.match<
        ...
        | SDKValidationError
    >(
        M.json(200, operations.GetMenuResponse$inboundSchema, { ctype: "application/hal+json" }),
