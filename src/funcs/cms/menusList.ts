...
> {
    const parsed = safeParse(
        request,
        (value) => operations.ListMenusRequest$outboundSchema.optional().parse(value),
    ...
    const [result] = await M.match<
        ...
        | SDKValidationError
    >(
        M.json(200, operations.ListMenusResponse$inboundSchema, { ctype: "application/hal+json" }),
