...
> {
    const parsed = safeParse(
        request,
        (value) => operations.ListPagesRequest$outboundSchema.optional().parse(value),
    ...
    const query = encodeFormQuery({
        ...
        "filter[published]": payload?.filterPublished,
    ...
    const [result] = await M.match<
        ...
        | SDKValidationError
    >(
        M.json(200, operations.ListPagesResponse$inboundSchema, { ctype: "application/hal+json" }),
