...
export function usersListRecoveryCodes(
    ...
    Result<
        operations.ListUserRecoveryCodesResponse,
...
> {
    const parsed = safeParse(
        request,
        (value) =>
            operations.ListUserRecoveryCodesRequest$outboundSchema.parse(value),
    ...
    const context = {
        ...
        operationID: "users.listRecoveryCodes",
        oAuth2Scopes: null,
    ...
    const [result] = await M.match<
        ...
        | SDKValidationError
    >(
        M.json(200, ListUserRecoveryCodesResponse$inboundSchema, {
