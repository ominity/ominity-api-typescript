...
import { ListUserOAuthAccountsResponse$inboundSchema } from "../../models/operations/users-oauth-accounts.js";
import { applyPaginationParams } from "../../models/pagination.js";
import { APICall, APIPromise } from "../../types/async.js";
import { OK, Result } from "../../types/fp.js";

export function usersListOAuthAccounts(
    client: ClientSDK,
...
> {
    const parsed = safeParse(
        request,
        (value) =>
            operations.ListUserOAuthAccountsRequest$outboundSchema.parse(value),
    ...
    const context = {
        ...
        operationID: "users.listOAuthAccounts",
        oAuth2Scopes: null,
    ...
    const [result] = await M.match<
        ...
        | SDKValidationError
    >(
        M.json(200, ListUserOAuthAccountsResponse$inboundSchema, {
