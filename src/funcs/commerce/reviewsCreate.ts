...
export function reviewsCreate(
    client: ClientSDK,
    request: operations.CreateReviewRequest,
    options?: RequestOptions,
): Promise<
    Result<
        operations.CreateReviewResponse,
        | OminityError
        | ConnectionError
        | InvalidRequestError
...
async function $do(
    ...
    >
> {
    const path = pathToFunc("/commerce/reviews")();
    ...
    const [result] = await M.match<
        ...
        | RequestTimeoutError
    >(
        M.json(201, operations.CreateReviewResponse$inboundSchema),
