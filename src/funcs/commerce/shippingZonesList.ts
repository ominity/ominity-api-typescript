...
export function shippingZonesList(
    ...
    Result<
        operations.ListShippingZonesResponse,
        | OminityError
        | ConnectionError
        | InvalidRequestError
...
async function $do(
    ...
    >
> {
    const path = pathToFunc("/commerce/shipping-zones")();
    ...
    const [result] = await M.match<
        ...
        | RequestTimeoutError
    >(
        M.json(200, operations.ListShippingZonesResponse$inboundSchema),
