...
export function customerUsersGet(
  client: ClientSDK,
  request: operations.GetCustomerUserRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GetCustomerUserResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetCustomerUserRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.GetCustomerUserResponse$inboundSchema, {
