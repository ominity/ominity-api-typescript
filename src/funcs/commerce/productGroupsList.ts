...
export function productGroupsList(
    ...
    Result<
        operations.ListProductGroupsResponse,
        | OminityError
        | ConnectionError
        | InvalidRequestError
...
async function $do(
    ...
    >
> {
    const path = pathToFunc("/commerce/product-groups")();
    ...
    const [result] = await M.match<
        ...
        | RequestTimeoutError
    >(
        M.json(200, operations.ListProductGroupsResponse$inboundSchema),
