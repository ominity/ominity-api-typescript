...
export function currenciesList(
    ...
    Result<
        operations.ListCurrenciesResponse,
        | OminityError
        | ConnectionError
        | InvalidRequestError
...
async function $do(
    ...
    >
> {
    const path = pathToFunc("/commerce/currencies")();
    ...
    const [result] = await M.match<
        ...
        | RequestTimeoutError
    >(
        M.json(200, operations.ListCurrenciesResponse$inboundSchema),
