/*
 * List shipping methods function.
 */
...
export function shippingMethodsList(
    client: ClientSDK,
    request?: operations.ListShippingMethodsRequest | undefined,
    options?: RequestOptions,
): Promise<
    Result<
        operations.ListShippingMethodsResponse,
        | OminityError
        | ConnectionError
        | InvalidRequestError
...
async function $do(
    ...
    >
> {
    const path = pathToFunc("/commerce/shipping-methods")();
    ...
    const [result] = await M.match<
        ...
        | RequestTimeoutError
    >(
        M.json(200, operations.ListShippingMethodsResponse$inboundSchema),
