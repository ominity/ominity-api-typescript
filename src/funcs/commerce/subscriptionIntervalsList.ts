/*
 * List subscription intervals function.
 */
...
export function subscriptionIntervalsList(
    client: ClientSDK,
    request?: operations.ListSubscriptionIntervalsRequest | undefined,
    options?: RequestOptions,
): Promise<
    Result<
        operations.ListSubscriptionIntervalsResponse,
        | OminityError
        | ConnectionError
        | InvalidRequestError
...
> {
    ...
    const [result] = await M.match<
        ...
        | RequestTimeoutError
    >(
        M.json(200, operations.ListSubscriptionIntervalsResponse$inboundSchema),
