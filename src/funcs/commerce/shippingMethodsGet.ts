...
export function shippingMethodsGet(
    client: ClientSDK,
    request: operations.GetShippingMethodRequest,
...
async function $do(
    ...
    >
> {
    const path = pathToFunc("/commerce/shipping-methods/{id}")({
        id: request.id,
    });
    ...
    const [result] = await M.match<
        ...
        | RequestTimeoutError
    >(
        M.json(200, operations.GetShippingMethodResponse$inboundSchema),
