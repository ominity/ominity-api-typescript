/*
 * Get subscription interval function.
 */
...
export function subscriptionIntervalsGet(
    client: ClientSDK,
    request: operations.GetSubscriptionIntervalRequest,
    options?: RequestOptions,
): Promise<
    Result<
        operations.GetSubscriptionIntervalResponse,
        | OminityError
        | ConnectionError
        | InvalidRequestError
...
> {
    ...
    const [result] = await M.match<
        ...
        | RequestTimeoutError
    >(
        M.json(200, operations.GetSubscriptionIntervalResponse$inboundSchema),
