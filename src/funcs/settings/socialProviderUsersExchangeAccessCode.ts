 ...
 */
export async function socialProviderUsersExchangeAccessCode(
    client: ClientSDK,
    request: operations.ExchangeSocialProviderAccessCodeRequest,
    options?: RequestOptions,
): Promise<
    Result<
        operations.ExchangeSocialProviderAccessCodeResponse,
        | OminityError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
    ...
    >
> {
    const input: operations.ExchangeSocialProviderAccessCodeRequest = request;
    ...
    const context = {
        operationID: "exchangeProviderAccessCode",
        oAuth2Scopes: [],
    ...
    const requestRes = client._createRequest(
        context,
        {
            security: security,
            method: "GET",
            path: pathToFunc("/settings/socialproviders/{providerId}/users/token")(input),
    ...
    >(
        M.json(
            200,
            operations.ExchangeSocialProviderAccessCodeResponse$inboundSchema,
        ),
        M.fail(
