...
import { encodeSimpleQuery, encodeDeepObjectQuery } from "../../lib/encodings.js";
...
export async function languagesList(
    ...
    Result<
        operations.ListLanguagesResponse,
        | OminityError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
    ...
    >
> {
    const input: operations.ListLanguagesRequest =
        request ?? {};
    ...
    const requestRes = client._createRequest(
        context,
        {
            security: security,
            method: "GET",
            path: pathToFunc("/settings/languages")(),
    ...
    >(
        M.json(
            200,
            operations.ListLanguagesResponse$inboundSchema,
        ),
        M.fail(
