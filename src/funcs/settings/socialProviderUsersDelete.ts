 ...
 */
export async function socialProviderUsersDelete(
    client: ClientSDK,
    request: operations.DeleteSocialProviderUserRequest,
    options?: RequestOptions,
): Promise<
    Result<
        operations.DeleteSocialProviderUserResponse,
        | OminityError
        | SDKValidationError
        | UnexpectedClientError
        | InvalidRequestError
    ...
    >
> {
    const input: operations.DeleteSocialProviderUserRequest = request;
    ...
    const context = {
        operationID: "deleteSocialProviderUser",
        oAuth2Scopes: [],
    ...
    const requestRes = client._createRequest(
        context,
        {
            security: security,
            method: "DELETE",
            path: pathToFunc("/settings/socialproviders/{providerId}/users/{id}")(input),
    ...
    >(
        M.nil(
            204,
            operations.DeleteSocialProviderUserResponse$inboundSchema,
        ),
        M.fail(
