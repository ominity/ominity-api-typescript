...
import { ListAdminsResponse$inboundSchema } from "../../models/operations/admins.js";
...
> {
    const parsed = safeParse(
        request,
        (value) =>
            operations.ListAdminsRequest$outboundSchema.optional().parse(value),
    ...
    const [result] = await M.match<
        ...
        | SDKValidationError
    >(
        M.json(200, ListAdminsResponse$inboundSchema, {
