...
import { ChannelDomainsListResponse$inboundSchema } from "../../models/channels/channel-domain.js";
import { applyPaginationParams } from "../../models/pagination.js";
import { APICall, APIPromise } from "../../types/async.js";
import { OK, Result } from "../../types/fp.js";

export function channelDomainsList(
  client: ClientSDK,
  request: operations.ListChannelDomainsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListChannelDomainsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListChannelDomainsRequest$outboundSchema.parse(value),
  ...
  const path = `/channels/${payload.channelId}/domains`;
  ...
  const context = {
    ...
    operationID: "channels.domains.list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ChannelDomainsListResponse$inboundSchema, {
