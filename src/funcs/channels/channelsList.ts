...
import { ChannelsListResponse$inboundSchema } from "../../models/channels/channel.js";
...
export function channelsList(
  ...
  Result<
    operations.ListChannelsResponse,
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ChannelsListParams$outboundSchema.optional().parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ChannelsListResponse$inboundSchema, {
