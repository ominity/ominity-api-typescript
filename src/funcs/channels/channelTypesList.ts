...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ChannelTypesListParams$outboundSchema.optional().parse(value),
  ...
  const context = {
    ...
    operationID: "channels.types.list",
    oAuth2Scopes: null,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, ChannelTypesListResponse$inboundSchema, {
